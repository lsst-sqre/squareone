...
/**
 * Client component for Times Square home page content.
 *
 * Renders the introductory content and documentation for Times Square
 * within the TimesSquareApp layout wrapper.
 */
export default function TimesSquareHomeContent() {
  return (
    <TimesSquareApp>
