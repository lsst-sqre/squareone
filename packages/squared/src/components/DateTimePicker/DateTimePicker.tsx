                ...
                <div className={styles.calendarContainer}>
                  <DayPicker
                    ...
                    classNames={{
                      ...
                      month_grid: styles.calendarTable,
                      weekdays: styles.calendarHeadRow,
                      weekday: styles.calendarHeadCell,
                      week: styles.calendarRow,
                      day: [styles.calendarCell, styles.calendarDay].join(' '),
                      selected: styles.calendarDaySelected,
                      today: styles.calendarDayToday,
                      outside: styles.calendarDayOutside,
                      disabled: styles.calendarDayDisabled,
                      hidden: styles.calendarDayHidden,
                    }}
                  />
