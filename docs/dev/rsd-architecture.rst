##########################################
Architecture of the Rubin Style Dictionary
##########################################
...
|RSD| uses a :doc:`customized build process <rsd-build-system>` that allows you to define both *global design tokens* and *component-level design tokens,* as well as associate specific token values with *themes* (such as light and dark).
...
Tokens are defined in YAML files that reside in the :file:`src` directory of the rubin-style-dictionary package.
